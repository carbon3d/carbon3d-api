...
class ModelsApi(object):
    ...
    def get_models(self, limit, offset, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_models_with_http_info(limit, offset, **kwargs)  # noqa: E501

    def get_models_with_http_info(self, limit, offset, **kwargs):  # noqa: E501
        """Fetch models  # noqa: E501

        Fetch Models, filtered by the respective query parameters (most recent first)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_models_with_http_info(limit, offset, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('offset' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `offset` when calling `get_models`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `get_models`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def upload_model(self, filename, **kwargs):  # noqa: E501
        ...
        :param float application_id: Application ID
        :param file body:
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
