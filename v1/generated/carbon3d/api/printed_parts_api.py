...
class PrintedPartsApi(object):
    ...
    def get_printed_parts(self, limit, offset, **kwargs):  # noqa: E501
        """Fetch printed parts  # noqa: E501

        Gets a list of Part entities (most recent first)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_printed_parts(limit, offset, async_req=True)
        >>> result = thread.get()
        ...
        :param str order_uuid: Order UUID
        :param str part_uuid: Part UUID
        :param str order_number: Customer-provided order number the printed parts belong to
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_printed_parts_with_http_info(limit, offset, **kwargs)  # noqa: E501

    def get_printed_parts_with_http_info(self, limit, offset, **kwargs):  # noqa: E501
        """Fetch printed parts  # noqa: E501

        Gets a list of Part entities (most recent first)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_printed_parts_with_http_info(limit, offset, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['limit', 'offset', 'status', 'order_uuid', 'part_uuid', 'order_number', 'sort']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('offset' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `offset` when calling `get_printed_parts`")  # noqa: E501
        ...
        if 'order_uuid' in local_var_params and local_var_params['order_uuid'] is not None:  # noqa: E501
            query_params.append(('order_uuid', local_var_params['order_uuid']))  # noqa: E501
