...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of carbon3d.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the carbon3d.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = carbon3d.Configuration(
        signing_info = carbon3d.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://api-sandbox.carbon3d.com/v1",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("carbon3d")
