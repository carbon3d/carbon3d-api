...
class OrdersResponseOrders(object):
    ...
    def __init__(self, uuid=None, status=None, order_number=None, printed_parts_count=None, due_date=None, route_to=None, local_vars_configuration=None):  # noqa: E501
