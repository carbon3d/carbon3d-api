# carbon3d.ModelExperimentalApi

All URIs are relative to *https://api.carbon3d.com/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_models**](ModelExperimentalApi.md#get_models) | **GET** /models | Fetch models
...
with carbon3d.ApiClient(configuration) as api_client:
    ...
    api_instance = carbon3d.ModelExperimentalApi(api_client)
...
sort = ['sort_example'] # list[str] | Field(s) to sort by. Ascending order by default, use `sort=field,desc` to specify descending order. Sortable fields are: `uuid`, `updated_at`, `filename` (optional)
    ...
    try:
        ...
        print("Exception when calling ModelExperimentalApi->get_models: %s\n" % e)
```
