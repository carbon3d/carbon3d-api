...
*AutomationRunsApi* | [**create_automation_run**](docs/AutomationRunsApi.md#create_automation_run) | **POST** /automation_runs | Create a AutomationRun
*AutomationRunsApi* | [**get_automation_run**](docs/AutomationRunsApi.md#get_automation_run) | **GET** /automation_runs/{uuid} | Fetch an automation_run
*AutomationRunsApi* | [**get_automation_runs**](docs/AutomationRunsApi.md#get_automation_runs) | **GET** /automation_runs | Fetch automation runs
...
## Documentation For Models
 ...
 - [AutomationRunRequest](docs/AutomationRunRequest.md)
 - [AutomationRunSteps](docs/AutomationRunSteps.md)
 - [AutomationRunsResponse](docs/AutomationRunsResponse.md)
 - [Build](docs/Build.md)
