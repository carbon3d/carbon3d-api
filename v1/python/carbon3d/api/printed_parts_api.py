...
class PrintedPartsApi(object):
    ...
    def get_printed_parts(self, limit, **kwargs):  # noqa: E501
        ...
        :param datetime started_before: Started before time X
        :param datetime started_after: Started after time X
        :param datetime finished_before: Finished before time X
        :param datetime finished_after: Finished after time X
