...
class PartsApi(object):
    ...
    def get_parts_with_http_info(self, limit, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('application_id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `application_id` when calling `get_parts`, number of items must be less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and ('application_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['application_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `application_id` when calling `get_parts`, number of items must be greater than or equal to `1`")  # noqa: E501
