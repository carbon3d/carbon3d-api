...
class PartMeasurementTemplatesApi(object):
    ...
    def get_part_measurement_templates(self, limit, **kwargs):  # noqa: E501
        """Fetch part measurement templates  # noqa: E501

        Gets a list of part measurement templates  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_part_measurement_templates(limit, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_part_measurement_templates_with_http_info(limit, **kwargs)  # noqa: E501

    def get_part_measurement_templates_with_http_info(self, limit, **kwargs):  # noqa: E501
        """Fetch part measurement templates  # noqa: E501

        Gets a list of part measurement templates  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_part_measurement_templates_with_http_info(limit, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PartMeasurementTemplateResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_part_measurement_templates" % key
                )
        ...
        if self.api_client.client_side_validation and ('limit' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `limit` when calling `get_part_measurement_templates`")  # noqa: E501

        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] > 1000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_part_measurement_templates`, must be a value less than or equal to `1000`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_part_measurement_templates`, must be a value greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and ('uuid' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `uuid` when calling `get_part_measurement_templates`, number of items must be less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and ('uuid' in local_var_params and  # noqa: E501
                                                        len(local_var_params['uuid']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `uuid` when calling `get_part_measurement_templates`, number of items must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and ('application_id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `application_id` when calling `get_part_measurement_templates`, number of items must be less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and ('application_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['application_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `application_id` when calling `get_part_measurement_templates`, number of items must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and ('application_uuid' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `application_uuid` when calling `get_part_measurement_templates`, number of items must be less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and ('application_uuid' in local_var_params and  # noqa: E501
                                                        len(local_var_params['application_uuid']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `application_uuid` when calling `get_part_measurement_templates`, number of items must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/part_measurement_templates', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='PartMeasurementTemplateResponse',  # noqa: E501
