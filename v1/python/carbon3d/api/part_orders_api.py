...
class PartOrdersApi(object):
    ...
    def delete_part_order(self, uuid, **kwargs):  # noqa: E501
        ...
        Cancel an existing eligible PartOrder. Orders may only be canceled while they are in 'open' status.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_part_orders(self, limit, offset, **kwargs):  # noqa: E501
        """Fetch part orders  # noqa: E501

        Fetch a list of `PartOrder` entities (most recent first)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_part_orders(limit, offset, async_req=True)
        >>> result = thread.get()
        ...
        :param list[str] sort: Field(s) to sort by. Ascending order by default, use `sort=field,desc` to specify descending order. Sortable fields are: `part_order_number`, `due_date`, `flushed_at`
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_part_orders_with_http_info(limit, offset, **kwargs)  # noqa: E501

    def get_part_orders_with_http_info(self, limit, offset, **kwargs):  # noqa: E501
        """Fetch part orders  # noqa: E501

        Fetch a list of `PartOrder` entities (most recent first)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_part_orders_with_http_info(limit, offset, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('offset' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `offset` when calling `get_part_orders`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `get_part_orders`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
