...
class Build(object):
    ...
    def __init__(self, uuid=None, packing_group=None, parts=None, attachments=None, name=None, revision=None, status=None, local_vars_configuration=None):  # noqa: E501
