...
class BuildsResponse(object):
    ...
    def __init__(self, limit=None, next_cursor=None, total_count=None, builds=None, local_vars_configuration=None):  # noqa: E501
    ...
    def next_cursor(self):
        """Gets the next_cursor of this BuildsResponse.  # noqa: E501

        the cursor that should be used to retrieve the next page of results  # noqa: E501

        :return: The next_cursor of this BuildsResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def next_cursor(self, next_cursor):
        """Sets the next_cursor of this BuildsResponse.

        the cursor that should be used to retrieve the next page of results  # noqa: E501

        :param next_cursor: The next_cursor of this BuildsResponse.  # noqa: E501
        :type: str
        """
