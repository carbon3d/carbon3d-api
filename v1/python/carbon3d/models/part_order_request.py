...
class PartOrderRequest(object):
    ...
    def __init__(self, part_order_number=None, parts=None, due_date=None, route_to=None, flush=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def route_to(self):
        """Gets the route_to of this PartOrderRequest.  # noqa: E501

        Section(s) to route this part order to (e.g. a rework line)  # noqa: E501

        :return: The route_to of this PartOrderRequest.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def route_to(self, route_to):
        """Sets the route_to of this PartOrderRequest.

        Section(s) to route this part order to (e.g. a rework line)  # noqa: E501

        :param route_to: The route_to of this PartOrderRequest.  # noqa: E501
        :type: list[str]
        """
