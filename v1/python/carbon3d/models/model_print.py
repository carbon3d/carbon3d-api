...
class ModelPrint(object):
    ...
    def __init__(self, name=None, print_id=None, build_uuid=None, finished_at=None, started_at=None, remaining_sec=None, printed_by=None, print_order_uuid=None, print_order_number=None, status=None, origin=None, config=None, metrics=None, feedback=None, local_vars_configuration=None):  # noqa: E501
