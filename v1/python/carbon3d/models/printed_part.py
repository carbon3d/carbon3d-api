...
class PrintedPart(object):
    ...
    def __init__(self, uuid=None, part_uuid=None, model_uuid=None, part_number=None, build_uuid=None, part_order_uuid=None, part_order_number=None, print_order_uuid=None, print_order_number=None, print_id=None, print_uuid=None, serial_number=None, created_at=None, updated_at=None, finished_at=None, tags=None, status=None, error=None, local_vars_configuration=None):  # noqa: E501
