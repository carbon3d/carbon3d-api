...
class PrintedPart(object):
    ...
    def __init__(self, uuid=None, part_order_uuid=None, part_uuid=None, genealogy=None, status=None, serial_number=None, build_uuid=None, error=None, local_vars_configuration=None):  # noqa: E501
