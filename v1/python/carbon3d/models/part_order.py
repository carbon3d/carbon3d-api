...
class PartOrder(object):
    ...
    def __init__(self, uuid=None, status=None, part_order_number=None, due_date=None, printed_parts=None, flushed_at=None, build_uuids=None, build_sop_uuid=None, local_vars_configuration=None):  # noqa: E501
