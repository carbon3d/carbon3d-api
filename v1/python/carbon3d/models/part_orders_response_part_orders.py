...
class PartOrdersResponsePartOrders(object):
    ...
    def __init__(self, uuid=None, status=None, part_order_number=None, printed_parts_count=None, due_date=None, route_to=None, flushed_at=None, part_uuids=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def route_to(self):
        """Gets the route_to of this PartOrdersResponsePartOrders.  # noqa: E501

        Section to route this part order to (e.g. production, a rework line)  # noqa: E501

        :return: The route_to of this PartOrdersResponsePartOrders.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def route_to(self, route_to):
        """Sets the route_to of this PartOrdersResponsePartOrders.

        Section to route this part order to (e.g. production, a rework line)  # noqa: E501

        :param route_to: The route_to of this PartOrdersResponsePartOrders.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def part_uuids(self):
        """Gets the part_uuids of this PartOrdersResponsePartOrders.  # noqa: E501

        List of part_uuids for given order  # noqa: E501

        :return: The part_uuids of this PartOrdersResponsePartOrders.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def part_uuids(self, part_uuids):
        """Sets the part_uuids of this PartOrdersResponsePartOrders.

        List of part_uuids for given order  # noqa: E501

        :param part_uuids: The part_uuids of this PartOrdersResponsePartOrders.  # noqa: E501
        :type: list[str]
        """
