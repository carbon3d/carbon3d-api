...
class PrintOrderRequest(object):
    ...
    def __init__(self, build_uuid=None, total_copies=1, route_to=None, print_order_number=None, print_order_tags=None, notes=None, uuid=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def uuid(self):
        """Gets the uuid of this PrintOrderRequest.  # noqa: E501

        UUID of the print order to create. If not provided, a UUID will be generated.  # noqa: E501

        :return: The uuid of this PrintOrderRequest.  # noqa: E501
        :rtype: str
        """
        return self._uuid
    ...
    @uuid.setter
    def uuid(self, uuid):
        """Sets the uuid of this PrintOrderRequest.

        UUID of the print order to create. If not provided, a UUID will be generated.  # noqa: E501

        :param uuid: The uuid of this PrintOrderRequest.  # noqa: E501
        :type: str
        """
